...
export default class BasicModalExample extends React.Component {
    constructor(props) {
        ...
        this.onButtonClick3 = () => {
            Modal.prompt('登录', '输入用户名和密码', (login, password) => console.log(`login: ${login}, password: ${password}`), 'login-password');
        };
        this.onButtonClick4 = () => {
            Modal.prompt('输入密码', '这是密码message,可以不要', password => console.log(`password: ${password}`), 'secure-text', 'defaultValue');
        };
        this.state = {
            visible: false,
            visible2: false,
    ...
    render() {
        ...
        <Modal transparent={false} popup visible={this.state.visible2} animationType="slide-up" maskClosable closable onClose={this.onClose2}>
        ...
        <Modal title="测试" transparent onClose={this.onClose} maskClosable visible={this.state.visible} closable footer={footerButtons}>
          <View style={{ paddingVertical: 20 }}>
            <Text style={{ textAlign: 'center' }}>这是内容...</Text>
            <Text style={{ textAlign: 'center' }}>这是内容...</Text>
          </View>
